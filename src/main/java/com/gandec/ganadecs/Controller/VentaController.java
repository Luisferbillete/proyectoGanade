...
public class VentaController {
    ...
    @GetMapping("/VentaBovinoPorpropietario/{idPropietario}")
    public Page<VentaClienteDetalleBovino> VentaBovinoPorpropietario(@PathVariable Long idPropietario,
                                                                     @RequestParam(name = "start") Integer start,
                                                                     @RequestParam(name = "limit") Integer limit) {
        return ventaService.VentaBovinoPorpropietario(idPropietario, start, limit);
    }

    @GetMapping("/VentaBovinoPorComprador/{idComprador}")
    public Page<VentaClienteDetalleBovino> VentaBovinoPorComprador(@PathVariable Long idComprador,
                                                                   @RequestParam(name = "start") Integer start,
                                                                   @RequestParam(name = "limit") Integer limit) {
        return ventaService.VentaBovinoPorComprador(idComprador, start, limit);
    }
